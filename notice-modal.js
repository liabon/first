 ...
 * 사용법: <script src="/notice-modal.js"></script>  (각 페이지 </script> 앞에 추가)
 */
(function() {
    'use strict';
...
.notice-modal-body .notice-divider {\
    border: none;\
...
.notice-modal-footer .notice-agency {\
    font-size: 0.82rem;\
    color: #888;\
    line-height: 1.6;\
}\
.notice-modal-footer .notice-approval {\
    font-size: 0.78rem;\
    color: #bbb;\
    margin-top: 6px;\
}\
...
\
    ...
    <div class="notice-modal-footer">\
        <div class="notice-agency">\
            ...
            해당 모집종사자는 보험사로부터 보험계약체결권을 부여받지 아니한 금융판매 대리·중개업자입니다.<br><br>\
    ...
    // 카카오 플로팅 버튼이 있으면 위치 조정 (겹침 방지)
    var kakaoFloat = document.getElementById('kakaoFloat');
    if (kakaoFloat) {
        // 카카오 버튼이 오른쪽, 알아두실사항은 왼쪽 → 겹치지 않음
    }
